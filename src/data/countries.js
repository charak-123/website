// Country calling codes for the doctor registration phone field.
// `dial` is the calling code without the leading +; several countries share
// one (+1 across North America, +7 for Russia/Kazakhstan), which is why the
// country name is stored alongside the number rather than derived from it.
...
export const DIAL_BY_COUNTRY = Object.fromEntries(COUNTRIES.map((c) => [c.name, c.dial]));

// Countries doctors are most likely to pick, floated to the top of the list.
